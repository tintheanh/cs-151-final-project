...
public class JDateChooser extends JPanel implements ActionListener, PropertyChangeListener {
	...
	/**
	 * Creates a new JDateChooser. By default, no date is set and the textfield is
	 * empty.
	 */
	public JDateChooser() {
	 ...
	 * @param dateFormatString the date format string or null (then MEDIUM
	 *                         SimpleDateFormat format is used)
	 * @param dateEditor       the dateEditor to be used used to display the date.
	 *                         if null, a JTextFieldDateEditor is used.
	 */
	 ...
	 * constructor, the mask will be always visible in the date editor. Please note
	 * that the date pattern and the mask will not be changed if the locale of the
