...
public class JMonthChooser extends JPanel implements ItemListener, ChangeListener {
	...
	/**
	 * Sets the month attribute of the JMonthChooser object. Fires a property change
	 * "month".
	 * 
	 ...
	 * (January) and 11 (December). A value < 0 will be treated as 0, a value > 11
	 * will be treated as 11.
	 * 
	 * @param newMonth the new month value
	 * 
	 * @see #getMonth
	...
	/**
	 * Convenience method set a year chooser. If set, the spin for the month buttons
	 * will spin the year as well
	 * 
	...
	/**
	 * Returns the month chooser's comboBox text area (which allow the focus to be
	 * set to it).
	 * 
	...
	/**
	 * Returns the month chooser's comboBox bar (which allow the focus to be set to
	 * it).
	 * 
