...
public interface IDateEditor {
	...
	/**
	 * Sets the date format string, e.g. "MM/dd/yy". If the date format string is
	 * null or invalid, the date format string will be set to the MEDIUM Simple date
	 ...
	 * 
	 * @param min the minimum selectable date or null (then the minimum date should
	 *            be set to 01\01\0001)
	 * @param max the maximum selectable date or null (then the maximum date should
	 *            be set to 01\01\9999)
	 */
	...
	/**
	 * Sets the locale. Usually this should have impact on the current date format
	 * string.
	 * 
	...
	/**
	 * Adds a property change listener that should be added to the implementing UI
	 * component. The UI component should fire a "date" property if the date
	 * changes.
	 * 
	...
	/**
	 * Removes the listener from the date editor's property change listeners for the
	 * specific property.
	 * 
