...
public class AddTaskView extends javax.swing.JFrame {
        ...
        public AddTaskView(String currentTaskType, TaskComponent allTask, JTable taskTable) {
        ...
        private void initComponents() {
                ...
                layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(layout.createSequentialGroup().addContainerGap()
                                                .addComponent(addTaskViewLabel).addGap(6, 6, 6)
                                                .addGroup(layout.createParallelGroup(
                                                ...
                                                .addGroup(layout.createParallelGroup(
                                                                javax.swing.GroupLayout.Alignment.BASELINE)
                                                                .addComponent(taskTypeLabel).addComponent(taskType,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                ...
                                                .addGroup(layout.createParallelGroup(
                                                                javax.swing.GroupLayout.Alignment.LEADING)
                                                                .addComponent(noteLabel).addComponent(scrollPane,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE,
                                                                                javax.swing.GroupLayout.DEFAULT_SIZE,
                                                                                javax.swing.GroupLayout.PREFERRED_SIZE))
                                                .addGap(32, 32, 32)
                                                .addComponent(addBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 53,
                                                                javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                if (name.equals("") || date == null) {
                        ...
                        case "Home":
                                ...
                                if (currentTaskType.equals("Home Tasks")) {
                                        model.addRow(new Object[] { newTask.getId(), newTask.getTitle(),
                                                        newTask.getDate(), newTask.getStatus(),
                                                        newTask.getCategory() });
                                }
                                break;
                        case "School":
                        ...
                        if (currentTaskType.equals("All Tasks")) {
                                model.setDataVector(allTask.toAllTaskGroupArray(),
                                                new String[] { "ID", "Title", "Date", "Status", "Category" });
                        }
